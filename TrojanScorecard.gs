function main() {
  var spreadsheetUrl = "https://docs.google.com/spreadsheets/d/17tmy7-S-rIPCL56WhVnJ0j7X82_2Q-FTEB9P0z9obEI/edit?gid=654522033#gid=654522033";
  var sheetName = "Google Export";
  ...
  var headers = [
    ...
    "Search lost IS (budget)", "Reservation", "Rental Click", "Bid Strategy"
  ];
  ...
  while (campaignRows.hasNext()) {
    ...
    campaignData[campaignName] = {
      ...
      "BidStrategy": campaignBidStrategies[campaignName] || "Unknown", // Use the bid strategy we collected
